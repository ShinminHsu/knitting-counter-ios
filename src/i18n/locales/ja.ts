const ja = {
  ...
  upgrade: {
    ...
    template: {
      title: 'グループテンプレート',
      desc: 'テンプレートで針目の組み合わせを素早く適用できます。広告を見て永久解除、またはPremiumにアップグレード。',
    },
    export: {
      title: 'プロジェクトのエクスポート',
    ...
    plansTitle: 'プラン比較',
    plansTagline: 'Premiumにアップグレードして全機能を解放し、開発者を応援しましょう。',
    plansFree: '無料版',
    plansPremium: 'Premium',
    rowProjects: 'プロジェクト数',
    rowProjectsFree: '3個（広告で最大5）',
    rowProjectsPremium: '無制限',
    rowPhotos: '写真 / プロジェクト',
    rowPhotosFree: '1枚（広告で最大3）',
    rowPhotosPremium: '無制限',
    rowStitchCategories: '針目カテゴリ',
    rowStitchCategoriesFree: '基本 + 広告解除',
    rowStitchCategoriesPremium: 'すべて',
    rowCustomStitch: 'カスタム針目',
    rowTemplate: 'グループテンプレート',
    rowExport: 'エクスポート',
    adUnlockable: '広告で解除',
    watchAd: '広告を見てロック解除',
