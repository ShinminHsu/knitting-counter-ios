const ja = {
  ...
  stitch: {
    ...
    name: {
      ...
      cable_2st_rc: '左上交差',
      cable_2st_lc: '右上交差',
      cable_2st_rpc: '左上交差（裏目）',
      cable_2st_lpc: '右上交差（裏目）',
      magic_ring: 'わの作り目',
      chain: '鎖編み',
      slip_stitch: '引き抜き編み',
      single: '細編み',
  ...
  upgrade: {
    ...
    rowProjects: 'プロジェクト数',
    rowProjectsFree: '3個、広告で最大5個',
    rowProjectsPremium: '無制限',
    rowPhotos: '写真 / プロジェクト',
    rowPhotosFree: '1枚、広告で最大3枚',
    rowPhotosPremium: '無制限',
    rowStitchCategories: '針目カテゴリ',
    rowStitchCategoriesFree: '基本、広告でさらに解除',
    ...
    maybeLater: 'あとで',
    purchaseError: '購入に失敗しました。後でもう一度お試しください。',
    adUnavailableTitle: '広告を表示できません',
    adUnavailableDesc: '後でもう一度お試しいただくか、Premiumにアップグレードしてください。',
