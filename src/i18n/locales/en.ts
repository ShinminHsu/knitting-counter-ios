const en = {
  ...
  stitch: {
    ...
    name: {
      ...
      purl: 'Purl',
      yarn_over: 'Yarn Over',
      slip_wyib: 'Slip 1 With Yarn In Back',
      slip_wyif: 'Slip 1 With Yarn In Front',
      backward_loop_co: 'Backward Loop Cast-On',
      k_tbl: 'Knit 1 Through Back Loop',
      p_tbl: 'Purl 1 Through Back Loop',
      ...
      s2kp2: 'Slip 2 Knit 1 Pass 2 Over',
      sspp2: 'Slip Slip Purl Pass 2 Over',
      lli: 'Left Lifted Increase',
      llpi: 'Left Lifted Purl Increase',
      rli: 'Right Lifted Increase',
      rlpi: 'Right Lifted Purl Increase',
      cable_2st_rc: '2-Stitch Right Cross',
      cable_2st_lc: '2-Stitch Left Cross',
      cable_2st_rpc: '2-Stitch Right Purl Cross',
      cable_2st_lpc: '2-Stitch Left Purl Cross',
      ...
      ch3_picot: 'Ch-3 Picot',
      dtr: 'Double Treble Crochet',
      sc_inc: '2 Single Crochet Increase',
      sc3inc: '3 Single Crochet Increase',
      hdc_inc: '2 Half Double Crochet Increase',
      hdc3_inc: '3 Half Double Crochet Increase',
      dc_inc: '2 Double Crochet Increase',
      dc3_inc: '3 Double Crochet Increase',
  ...
  upgrade: {
    ...
    rowProjectsFree: '3, unlock up to 5 with ads',
    rowProjectsPremium: 'Unlimited',
    rowPhotos: 'Photos / project',
    rowPhotosFree: '1, unlock up to 3 with ads',
    rowPhotosPremium: 'Unlimited',
    rowStitchCategories: 'Stitch categories',
    rowStitchCategoriesFree: 'Basic, more with ads',
    ...
    adUnavailableDesc: 'Please try again later, or upgrade to Premium.',
