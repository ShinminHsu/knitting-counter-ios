const zhTW = {
  ...
  stitch: {
    ...
    name: {
      ...
      cable_2st_rc: '左上1針交叉',
      cable_2st_lc: '右上1針交叉',
      cable_2st_rpc: '左上1針交叉（上針）',
      cable_2st_lpc: '右上1針交叉（上針）',
      magic_ring: '魔術環',
      chain: '鎖針',
      slip_stitch: '引拔針',
      single: '短針',
  ...
  upgrade: {
    ...
    plansTitle: '方案比較',
    plansTagline: '升級 Premium，解鎖所有功能，支持獨立開發者。',
    plansFree: '免費版',
    plansPremium: 'Premium',
    rowProjects: '專案數',
    rowProjectsFree: '3 個，廣告解鎖至 5 個',
    rowProjectsPremium: '無限',
    rowPhotos: '照片 / 專案',
    rowPhotosFree: '1 張，廣告解鎖至 3 張',
    rowPhotosPremium: '無限',
    rowStitchCategories: '針法分類',
    rowStitchCategoriesFree: '基礎，廣告解鎖更多',
    rowStitchCategoriesPremium: '全部',
    rowCustomStitch: '自訂針法',
    rowTemplate: '群組樣板',
    rowExport: '匯出專案',
    adUnlockable: '廣告解鎖',
    watchAd: '看廣告解鎖',
    ...
    maybeLater: '以後再說',
    purchaseError: '購買失敗，請稍後再試。',
    adUnavailableTitle: '廣告暫時無法顯示',
    adUnavailableDesc: '請稍後再試，或選擇升級 Premium。',
