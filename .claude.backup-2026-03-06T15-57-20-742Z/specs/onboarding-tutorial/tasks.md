...
- [x] 1. 新增 ONBOARDING storage key 並建立 useOnboardingStore
...
- [x] 2. 新增 onboarding 翻譯 key（zh-TW）
...
- [x] 3. 新增 onboarding 翻譯 key（en, ja）
...
- [x] 5. 在 _layout.tsx 掛載 OnboardingCarousel
...
- [x]8. 整合 Spotlight 到 Project List Screen
  - File: `app/index.tsx`
...
- [x]9. 整合 Spotlight 到 Project Detail Screen
...
- [x]10. 整合 Spotlight 到 Chart Editor Screen
...
- [x]11. 新增 ROUND_EDITOR screen name 並整合 Spotlight 到 Round Editor Screen
...
- [x]12. 整合 Spotlight 到 Tracking Screen
...
- [x]13. 整合 Spotlight 到 Pattern Elements Screen
...
- [x]14. 擴充 guide.tsx 為完整 Help Center
  - File: `app/guide.tsx`
